	...
	<body>
		...
		<div id="show-categoria" class="content scaffold-show" role="main">
			...
			<ol class="property-list categoria">
				...
				<g:if test="${categoriaInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="categoria.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${categoriaInstance}" field="description"/></span>
				...
				<g:if test="${categoriaInstance?.title}">
				<li class="fieldcontain">
					<span id="title-label" class="property-label"><g:message code="categoria.title.label" default="Title" /></span>
					
						<span class="property-value" aria-labelledby="title-label"><g:fieldValue bean="${categoriaInstance}" field="title"/></span>
