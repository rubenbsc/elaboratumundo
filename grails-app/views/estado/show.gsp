	...
	<body>
		...
		<div id="show-estado" class="content scaffold-show" role="main">
			...
			<ol class="property-list estado">
				...
				<g:if test="${estadoInstance?.description}">
				<li class="fieldcontain">
					<span id="description-label" class="property-label"><g:message code="estado.description.label" default="Description" /></span>
					
						<span class="property-value" aria-labelledby="description-label"><g:fieldValue bean="${estadoInstance}" field="description"/></span>
					
				</li>
				</g:if>
			
				<g:if test="${estadoInstance?.pedidos}">
				<li class="fieldcontain">
					<span id="pedidos-label" class="property-label"><g:message code="estado.pedidos.label" default="Pedidos" /></span>
