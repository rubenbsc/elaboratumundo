...
<%--									<h4 class="panel-title"><a href="#">Prueba</a></h4>--%>
<%--								</div>--%>
<%--							</div>--%>
<%--						</div>--%>
<%--					</div>--%>
<%--				</div>--%>
				...
				<div class="col-sm-9 padding-right">
					<div class="product-details">
						<div class="col-sm-5"> <!-- Esta hay que cambiarla: más ancha y poner imagenes secundarias abajo -->
						...
						<div class="col-sm-7">
							<div class="product-information">
								<h2>${productoInstance?.name}</h2>
								<p>Web ID: ${productoInstance?.id}</p>
		...
		<!-- Botones de lo que se ajustaban al tamaño. En pruebas! -->
<div class="botones sociales" style="float:right">
		...
		<asset:javascript src="rrssb.min.js"/>
	</body>
</html>
